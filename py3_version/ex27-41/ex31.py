...
if door == "1":
    ...
    if bear == "1":
        ...
        print("The bear tears your legs off. Good job.")
    else:
        print("Well doing %s is probably better. The bear runs off." % bear)
    ...
    if insanity == "1" or insanity == "2":
        ...
        print("The insanity rots your mind into a pool of muck. Good job.")
